...
CREATE TABLE
    IF NOT EXISTS master_distributors (
        ...
        master_distributor_documents_url TEXT NOT NULL DEFAULT '',
        master_distributor_gst_number TEXT UNIQUE,
